...
# Targets
.PHONY: all format build_dir clean rebuild test help run run_test download_json_h

all: format build_dir download_json_h $(OUTPUT) ## Build the project with formatting
