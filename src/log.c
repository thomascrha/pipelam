...
static char *
get_level_colour (int log_level)
{
    switch (log_level)
        {
        case LOG_DEBUG:
...
void
bow_log_level_set (int log_level)
{
    current_log_level = log_level;
}

void
bow_log_message (int log_level, const char *file, int line, ...)
{
    ...
    fprintf (stderr, "%s %s %s:%d: ", datetime, importance_coloured, file,
             line);
